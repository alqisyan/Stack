class ProgramTumpukan {
	...
	public static void main(String args[]) {
		...
		push(tumpukan, "Intel");
		push(tumpukan, "AMD");
		push(tumpukan, "NVIDIA");
		push(tumpukan, "Qualcomm");
		push(tumpukan, "MediaTek");
		push(tumpukan, "Zilog");
		push(tumpukan, "Motorola");
		push(tumpukan, "STMicroprocessor");
		push(tumpukan, "Exynos");
		push(tumpukan, "Radeon");
		push(tumpukan, "PowerPC ");
		push(tumpukan, "Toshiba Microprocessor");
		System.out.println();
		bacaTumpukan(tumpukan);
		
		System.out.println("Hapus Data");
		clear(tumpukan);
		System.out.println("Kondisi data :");
		bacaTumpukan(tumpukan);
	}
}